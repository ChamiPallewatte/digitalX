		...
		<tr>
			<td colspan="3" class="cart-coupon">
				...
				<span class="cart-coupon-inner">
					...
					<form class="checkout_coupon" method="post">
						...
						<button type="submit" class="button apply_coupon<?php echo esc_attr( wc_wp_theme_get_element_class_name( 'button' ) ? ' ' . wc_wp_theme_get_element_class_name( 'button' ) : '' ); ?>" name="apply_coupon" value="<?php esc_attr_e( 'Apply Coupon', 'ave' ); ?>">
			...
			<td colspan="5" class="actions">
				...
				<div class="woo-actions-inner">
					...
					<button type="submit" class="button update_cart<?php echo esc_attr( wc_wp_theme_get_element_class_name( 'button' ) ? ' ' . wc_wp_theme_get_element_class_name( 'button' ) : '' ); ?>" name="update_cart" value="<?php esc_attr_e( 'Update cart', 'ave' ); ?>">

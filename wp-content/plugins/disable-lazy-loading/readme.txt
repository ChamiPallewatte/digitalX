...
Disable Lazy Load is developed and maintained by [Jeff Starr](https://twitter.com/perishable), 15-year [WordPress developer](https://plugin-planet.com/) and [book author](https://books.perishablepress.com/).
...
* Adds `loading="eager"` to attached images
...
* Renames plugin "Disable Lazy Load"
* Tests on PHP 7.4 and 8.0
